...
module.exports = {
	...
	async verify (sourceCode, options) {
		...
		const MAX_EXPECTED_COLUMNS_PER_LINE = 10000;

		return failures.sort((a, b) => (a.startLine + (a.startColumn / MAX_EXPECTED_COLUMNS_PER_LINE)) - (b.startLine + (b.startColumn / MAX_EXPECTED_COLUMNS_PER_LINE)));
	}
};
